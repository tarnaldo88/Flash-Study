...
public static class SeedData
{
    ...
    public static async Task EnsureSoftwareEngineerDeckAsync(SQLiteAsyncConnection db)
    {
        ...
        var cards = new List<Card>
        {
            ...
            new() { DeckId = deck.Id, Front = "What is DNS?", Back = "DNS (Domain Name System) maps domain names to IP addresses.", CreatedAt = now, UpdatedAt = now },
            ...
            new() { DeckId = deck.Id, Front = "What is GraphQL?", Back = "GraphQL (graph query language) allows clients to request specific data from APIs.", CreatedAt = now, UpdatedAt = now },
            ...
            new() { DeckId = deck.Id, Front = "What is a JWT?", Back = "JWT (JSON Web Token) is a signed JSON token used for claims and authentication.", CreatedAt = now, UpdatedAt = now },
